...
//						DT_VIS_STR, 0x04, 'Z', 'J', 'S', 'J',			//软件版本 4 ,过台子远程升级用
						DT_VIS_STR, 0x04, '0', '8', '9', 'g',			//软件版本 4 ,过台子远程升级用
//						DT_VIS_STR, 0x06, '1','7', '0','2','2','5',		//软件版本日期
						DT_VIS_STR, 0x06, '1','7', '0','8','0','3',		//软件版本日期
...
BYTE g_bInnerSoftVer[INN_SOFT_VER_LEN] = 
{
	...
	'0', '0', '0', 'b',     //版本4个字节 x.xx A 主版本.副版本 测试版本，正式归档的版本测试版本号为0
	 0x08, 0x08, 0x17,        		 //日期3个字节 BCD码，终端软件发布日期。
};

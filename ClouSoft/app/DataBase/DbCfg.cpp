...
//						DT_VIS_STR, 0x06, '1','7', '0','2','2','5',		//软件版本日期
						...
						DT_VIS_STR, 0x08, '0', '0', '0', '0', '0', '0','0','0',
};	//电气设备——版本信息
...
BYTE g_bInnerSoftVer[INN_SOFT_VER_LEN] = 
{
	...
	'0', '0', '0', 'M',     //版本4个字节 x.xx A 主版本.副版本 测试版本，正式归档的版本测试版本号为0
	 0x29, 0x08, 0x17,        		 //日期3个字节 BCD码，终端软件发布日期。
};
...
/*#ifdef MTREXC_ADDR_TPYE_TSA
	...
	0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,	////有功总电能量差动越限事件记录，属性2，属性6	28*n+2 = 282, n = 10
	...
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,	//0x3116 有功总电能量差动越限事件记录，属性6  282
...
TItemDesc g_EventDataDesc[] =   //事件类对象数据
{
	...
	{0x3B19,	PN_MASK_SIZE,DI_HIGH_PERM, DI_READ|DI_WRITE, 0, 	INFO_NONE,		FMT_UNK,		1,		},//0x3B19 抄读上报信息域和主动上报状态字的电表标志位
	{0x3B20, 	108,DI_HIGH_PERM, DI_READ|DI_WRITE, 0, 	INFO_NONE,		FMT_UNK,		POINT_NUM,		},//0x3B20 上报信息域和主动上报状态字 面向对象表和07表复用
};
...
BYTE g_EventDataDefault[] = 
{
	...
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, //0x3B19 抄读上报信息域和主动上报状态字的电表标志位
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, //0x3B20 上报信息域和主动上报状态字 面向对象表和07表复用
};
...
BYTE g_bParaDefault[] = 
{
	...
	0x01,0x20,//最多支持32个费率电价--只读
		,
...
///////////////////begin////////////////////
	...
	DT_STRUCT, 0x06, 
#ifdef VER_GWMJ
		DT_VIS_STR, 0x04, 'D', 'J', 'G', 'Z',	//厂商代号 4
#else
		DT_VIS_STR, 0x04, 'C', 'L', 'O', 'U',	//厂商代号 4
#endif
...
TItemDesc g_ESAMIfDesc[] = //EASM接口类对象
{
	...
	{0xF116,	2,		DI_HIGH_PERM, DI_READ|DI_WRITE, 0,	INFO_NONE,	FMT_UNK,		PN_NUM,	},//电表安全模式,1启用，2未启用，0未初始化化
};
...
#ifdef VER_GWMJ
	0x99, 0x03, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0C, 0x00, 0x0C, 0x00, 0x00,	//0x1002 16 各项的调试输出开关	  
#else
...
{ 
    ...
    {0x503c,    2,      DI_HIGH_PERM, DI_READ|DI_WRITE, 0,  INFO_NONE,  FMT_UNK,        1,      },  // 顶部状态栏测量点号显示
	...
	{0x6004,	1,			DI_HIGH_PERM, DI_READ|DI_WRITE, 0,	INFO_NONE,	FMT_UNK,		POINT_NUM,		},//抄表失败次数
};
...
{//----标识-----长度------------权限-----------读写--------偏移----写操作--------------格式----------Pn个数------格式描述串------测量点映射号----
	...
	{0xa1d0, 	17, 		DI_LOW_PERM, 	DI_READ|DI_WRITE, 0,	INFO_NONE, 		FMT_UNK, 		1}, //通信地址，属性2, 带格式 TSA ********
};
...
#ifdef VER_GWMJ
	0x01, //0xa1c0 1 是否保存调试信息（0：否 1：是）
#else
